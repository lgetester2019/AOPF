...
const steps = [
    {
        icon: <Clipboard className="text-white w-6 h-6 sm:w-8 sm:h-8 shrink-0 mt-1" />,
        title: "1. Предварительный аудит",
        description:
            "Оцениваем текущие процессы и выявляем ключевые риски по охране труда на вашем предприятии.",
    },
    {
        icon: <Search className="text-white w-6 h-6 sm:w-8 sm:h-8 shrink-0 mt-1" />,
    ...
    {
        icon: <FileText className="text-white w-6 h-6 sm:w-8 sm:h-8 shrink-0 mt-1" />,
    ...
    {
        icon: <Users className="text-white w-6 h-6 sm:w-8 sm:h-8 shrink-0 mt-1" />,
    ...
    {
        icon: <CheckCircle className="text-white w-6 h-6 sm:w-8 sm:h-8 shrink-0 mt-1" />,
