...
export default function AudienceBlock() {
    ...
    const description = `
        ...
        • выполнить СОУТ (в т.ч. замеры освещенности, шума, микроклимата);
        • разработать программу производственного контроля с замерами.

        Требования едины для всех. Нарушение грозит штрафами до 200 тыс. руб., приостановкой деятельности и, в случае ЧП, уголовной ответственностью.
    `;

    const points = [
        "Крупные промышленные предприятия",
        "Небольшие компании и ИП с наемным трудом",
        "Офисные и удалённые команды",
