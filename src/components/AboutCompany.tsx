...
export default function AboutCompany() {
    ...
    return (
        <section className="py-10 mb-24 mt-6 px-4 md:px-10 bg-green-700/60 rounded-3xl max-w-[1350px] mx-auto text-white">
            <div className="flex flex-col md:flex-row gap-12 mx-auto">
                <div className="md:w-1/2 space-y-4">
                    ...
                    <p className="text-white text-lg leading-relaxed">
                        Наша аккредитованная испытательная лаборатория работает уже более 10 лет. Мы предлагаем комплекс
                    ...
                    <ul className="list-disc list-inside text-white text-lg space-y-2">
                        ...
                        <li>Разработка и оформление технологических карт
                            на погрузо-разгрузочные работы (ПРР).</li>
